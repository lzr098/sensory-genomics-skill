...
class GeneCertaintyRule(ImpactRule):
    ...
    HIGH_CERTAINTY_GENES = {
        ...
        "OCA2", "TYRP1",
        "TAS2R38", "TAS2R16", "TAS2R19", "TAS1R2", "TAS1R3", "TAS1R1",
        "SCNN1A", "SCNN1B", "SCNN1G", "OTOP1", "OTOP2", "OTOP3",
        "SCN9A", "SCN10A", "SCN11A", "TRPV1", "TRPM8", "PIEZO1", "PIEZO2",
        "NGF", "NTRK1", "GRPR", "IL31RA", "CNGA2", "ADCY3",
        "HERC2", "SLC45A2", "SLC24A4", "SLC24A5", "IRF4",
        "CYP1A2", "LCT", "ALDH2", "ADH1B", "ACTN3", "EDAR", "OPRM1", "COMT",
    }
